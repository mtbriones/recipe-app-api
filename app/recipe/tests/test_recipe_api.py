...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_partial_update_recipe(self):
        ...
        payload = {'title': 'Chicken adobo', 'tags': [new_tag.id]}
        url = detail_url(recipe.id)
    ...
    def test_full_update_recipe(self):
        ...
        recipe.refresh_from_db()
        self.assertEqual(recipe.title, payload['title'])
        self.assertEqual(recipe.time_munites, payload['time_munites'])
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tag(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Chicken teriyaki')
        recipe2 = sample_recipe(user=self.user, title='Pork Adobo')
        tag1 = sample_tag(user=self.user, name='Vegan')
    ...
    def test_filter_recipe_by_ingredients(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Banana Queue')
        recipe2 = sample_recipe(user=self.user, title='Nilagang Kanin')
        ...
        recipe3 = sample_recipe(user=self.user, title='Tokwat baboy')
